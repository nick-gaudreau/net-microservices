...
namespace CommandsService.EventProcessing
{
    public class EventProcessor : IEventProcessor
    {
        ...
        {
            // We can;t simply inject the repository here, since this service, EventProcessor has a Singleton scope
            // And the repostiory have a shorter scope => Scoped... so the process holding a repository could be killed before we can use it
